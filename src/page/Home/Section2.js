        ...
        <Container>
            <Row>
                <Col lg={{span:8, offset:2}} className='text-center'>
                    <h2>The burger testes better when you eat it with your faimly</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque at est id ligula facilisis lacinia.laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt.</p>
